...
export interface IpcMainCopy {
  handle(channel: string, listener: (event: IpcMainInvokeEventCopy, ...args: any[]) => (Promise<any>) | (any)): void
  handleOnce(channel: string, listener: (event: IpcMainInvokeEventCopy, ...args: any[]) => (Promise<any>) | (any)): void
