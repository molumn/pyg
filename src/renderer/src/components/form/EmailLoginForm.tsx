...
const EmailInput = ({ className, ...props }: ComponentProps<'input'>): ReactNode => {
  return (
    <div
      className={twMerge(
        'group w-[400px] h-[40px] rounded-3xl flex flex-row items-center justify-center',
        themeBackgroundClass.dust.highlight
      )}
    >
      ...
      <input
        type={'email'}
        className={twMerge(
          'grow mr-[4px] h-[32px] self-center justify-self-center rounded-r-3xl border-0',
